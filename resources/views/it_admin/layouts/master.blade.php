...
<head>
    ...
    <title>@yield('title', 'IT Admin Control Panel')</title>
...
<body class="bg-white transition-colors duration-300">
    ...
    <div class="dashboard-layout">
                ...
                <div class="profile-container">
                    <button id="profile-btn" class="profile-trigger">
                        <div class="profile-avatar-gradient">
                            <div class="profile-avatar-inner"
                                ...
                                {{ strtoupper(substr(Auth::guard('admin')->user()->name ?? 'IT', 0, 2)) }}
                            </div>
                        </div>
                        <div class="profile-info">
                            <p class="profile-name">{{ Auth::guard('admin')->user()->name ?? 'IT Admin' }}</p>
                    ...
                    <div id="profile-dropdown" class="dropdown-menu">
                        <div class="dropdown-header">
                            ...
                            <p class="dropdown-user-name">{{ Auth::guard('admin')->user()->name ?? 'IT Admin' }}</p>
                        </div>
        ...
        <div class="dashboard-wrapper">
            <!-- Sidebar Navigation -->
            @include('it_admin.layouts.navitems.sidebar')
