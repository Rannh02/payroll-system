...
@section('title', 'Approved Claims - VIA Architects Associates')
...
<div class="claims-page">
    ...
    <div class="page-header">
        <div>
            <h2 class="page-title">Approved Claims</h2>
            <p class="page-subtitle">Leave and allowance requests that have been approved</p>
        </div>
        <span class="count-pill">
            <i data-lucide="check-circle" style="width:14px;height:14px;"></i>
            {{ $claims->count() }} Approved
        </span>
    </div>

    <div class="panel">
        <div class="panel-header">
            <span class="panel-title">Approved Leave / Allowance Requests</span>
        </div>
