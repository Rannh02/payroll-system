...
@section('title', 'Other Deductions - VIA Architects Associates')
...
<style>
    ...
    .summary-card-single {
        ...
        box-shadow: 0 1px 4px rgba(0,0,0,0.04); border-top: 3px solid #8b5cf6;
    }
...
<div class="deductions-page">
    ...
    <div class="page-header">
        <div>
            <h2 class="page-title">Other Deductions</h2>
            <p class="page-subtitle">Miscellaneous deductions not classified under government contributions or loans</p>
        </div>
    </div>

    {{-- Date Filter --}}
    <form method="GET" action="{{ route('finance_admin.deductions.other') }}">
    ...
    <div class="summary-card-single">
        <div>
            <div class="summary-label">Total Other Deductions</div>
    ...
    <div class="panel">
        <div class="panel-header">
            <span class="panel-title">Other Deduction Records</span>
            <span style="font-size:0.8rem;color:#64748b;">Miscellaneous / Tardiness / Others</span>
        </div>
        <div class="table-wrap">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="deduction-type-badge">{{ $row['deduction_name'] }}</span></td>
                        ...
                        <td class="text-right money" style="color:#7c3aed;font-weight:700;">₱{{ number_format($row['amount'], 2) }}</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
            ...
            <div class="empty-state">
                <i data-lucide="list" style="width:3rem;height:3rem;margin:0 auto 0.75rem;display:block;opacity:0.2;"></i>
                <p>No other deductions found for the selected period.</p>
            </div>
            @endif
        </div>
    </div>
