                ...
                <div class="form-card">
                    ...
                    <form action="#" method="POST" class="form-group-stack">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="user_new_password" name="password" class="form-input" placeholder="Min 15 chars: A-z, 0-9, symbols">
...
<script>
    ...
    const pwInput = document.getElementById('user_new_password');
    if (pwInput) {
